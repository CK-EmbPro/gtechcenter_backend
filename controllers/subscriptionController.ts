...
export const createSubscription = async(req: Request, res: Response)=>{
    try {
        ...
        const createdSubscription = new SubscriptionModel({email, name, subscriptionDate, subscriptionTime})
...
export const updateSubscription = async(req: Request, res: Response)=>{
    try {
        ...
        const updatedSubscription = await SubscriptionModel.findByIdAndUpdate(sub_id, updatedSubscriptionData,{new: true})
...
export const deleteSubscription = async(req: Request, res: Response)=>{
    try {
        const {sub_id} = req.params
        const deletedSubscription = await SubscriptionModel.findByIdAndDelete(sub_id)
